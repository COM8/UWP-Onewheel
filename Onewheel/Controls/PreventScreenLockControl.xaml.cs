...
namespace Onewheel.Controls
{
    public sealed partial class PreventScreenLockControl : UserControl
    {
        ...
        {
            screenLock_tggls.IsOn = !DataManager.Classes.Settings.getSettingBoolean(SettingsConsts.DISABLE_PREVENT_SCREEN_LOCK);
        }

        private void screenLock_tggls_Toggled(object sender, RoutedEventArgs e)
        {
            DataManager.Classes.Settings.setSetting(SettingsConsts.DISABLE_PREVENT_SCREEN_LOCK, !screenLock_tggls.IsOn);
